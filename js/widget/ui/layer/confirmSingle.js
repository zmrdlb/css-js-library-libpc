 ...
 * 注意：该confrim控制的对象及dom在全局中唯一存在，如果想要创建多个，请使用layers/confirm或layers/confirmControl
 * @version 1.0.0 | 2015-09-16 版本信息
 * @author Zhang Mingrui | 592044573@qq.com
 * @example
 * requirejs(['layer/confirmSingle'],function($confirmSingle){
 ...
 * */
define(['layers/confirmControl'],function($confirmControl){
