 ...
 * @return 
 * @example
 * requirejs(['$','evt/inputchange'],function($,$inputchange){
 ...
 * });
 * */
define(['$','compatible/deviceevtname','dom/checknode','base/checkDataType'],function($,$deviceevtname,$checknode,$checkDataType){
    /**
     * 监听输入框值改变类 
    ...
    function Inputchange(node,trim){
        $checknode(node,'组件evt/inputchange传入参数无效');
