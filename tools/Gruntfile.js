module.exports = function(grunt) {
	 ...
	 */
	var requirejsconfig = {
	    appDir: "../js", //将appDir下的代码全部压缩复制到dir参数指定的目录中，路径指向同requirejs.config的baseUrl相同的路径
        dir: "../build/js", //目标文件夹
	    ...
	    */
		//exclude: {'layer/alertControl':['layer/bombLayer']} 
	};
        ...
        grunt.config.set('requirejs',{
            compile: { //requirejs官方标准配置
                options: {
                    ...
                    fileExclusionRegExp: /^core|manager|demo|template/, //指定不复制到目标文件夹的文件
	...
	grunt.registerTask('default', 'default', function(){
		grunt.task.run(['addfiles','requirejs','copy']);
	});
};